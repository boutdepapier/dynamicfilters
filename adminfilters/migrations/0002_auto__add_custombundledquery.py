...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomBundledQuery'
        db.create_table('adminfilters_custombundledquery', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('custom_filter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bundled_queries', to=orm['adminfilters.CustomFilter'])),
            ('module_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('class_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal('adminfilters', ['CustomBundledQuery'])


    def backwards(self, orm):
        # Deleting model 'CustomBundledQuery'
        db.delete_table('adminfilters_custombundledquery')


    models = {
        'adminfilters.custombundledquery': {
            'Meta': {'object_name': 'CustomBundledQuery'},
            'class_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'custom_filter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bundled_queries'", 'to': "orm['adminfilters.CustomFilter']"}),
            'field': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'module_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
